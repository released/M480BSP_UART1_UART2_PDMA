...
void PDMA_IRQHandler(void)
{
    ...
    UART1_P.cnt = ((uint32_t)((((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->DSCT[((0))]. CTL&(0xfffful << (16))) >> (16)));  



    UART2_P.cnt = ((uint32_t)((((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->DSCT[((1))]. CTL&(0xfffful << (16))) >> (16)));  
    ...
    if (status & (0x1ul << (0)))    
    {
        ...
        if (((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->ABTSTS)) & ((1 << (0))))
        {
            printf("UART1_PDMA_OPENED_CH_RX\r\n");
            ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->ABTSTS = (((1 << (0))))));
        }

        

        if (((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->ABTSTS)) & ((1 << (1))))
        {
            printf("UART2_PDMA_OPENED_CH_RX\r\n");
            ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->ABTSTS = (((1 << (1))))));
        }
    ...
    else if (status & (0x1ul << (1)))      
    {
        ...
        if (((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS)) & (1 << (0)))
        {
            ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS = ((1 << (0)))));

             
            UART1_P.g_u32comRbytes += UART1_P.g_u32cntbak + 1;  
            UART1_P.g_u32comRtail = (UART1_P.g_u32comRtail + UART1_P.g_u32cntbak + 1) % (64);  
            UART1_P.g_u32cntbak = (64) / 2 - 1;  

            UART1_P.g_u8PackageComplete = 1;
            
			( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_UART1_RX_end))) : ((BitFlag&=~(uint32_t)(1<<flag_UART1_RX_end))));
        } 



        if (((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS)) & (1 << (1)))
        {
            ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->TDSTS = ((1 << (1)))));

             
            UART2_P.g_u32comRbytes += UART2_P.g_u32cntbak + 1;  
            UART2_P.g_u32comRtail = (UART2_P.g_u32comRtail + UART2_P.g_u32cntbak + 1) % (64);  
            UART2_P.g_u32cntbak = (64) / 2 - 1;  

            UART2_P.g_u8PackageComplete = 1;
            
			( ((1UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_UART2_RX_end))) : ((BitFlag&=~(uint32_t)(1<<flag_UART2_RX_end))));
        } 
...
#line 312 "..\\main.c"
    ...
    else if (status & ((0x1ul << (8))))      
    {
        
         
        UART1_P.g_u32comRbytes += UART1_P.g_u32cntbak - UART1_P.cnt;   
        UART1_P.g_u32comRtail = (UART1_P.g_u32comRtail + UART1_P.g_u32cntbak - UART1_P.cnt) % (64);   
        UART1_P.g_u32cntbak = UART1_P.cnt;  

        UART1_P.g_u8PackageComplete = 0;

         
        PDMA_SetTimeOut(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (0), (0UL), 0);
        ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->INTSTS = (1 << (((0)) + 8))));
        PDMA_SetTimeOut(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (0), (1UL), (0x5555));
    }


    else if (status & ((0x1ul << (9))))      
    {
        
         
        UART2_P.g_u32comRbytes += UART2_P.g_u32cntbak - UART2_P.cnt;   
        UART2_P.g_u32comRtail = (UART2_P.g_u32comRtail + UART2_P.g_u32cntbak - UART2_P.cnt) % (64);   
        UART2_P.g_u32cntbak = UART2_P.cnt;  

        UART2_P.g_u8PackageComplete = 0;

         
        PDMA_SetTimeOut(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (1), (0UL), 0);
        ((uint32_t)(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->INTSTS = (1 << (((1)) + 8))));
        PDMA_SetTimeOut(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (1), (1UL), (0x5555));        
    }    
...
void UART1_UART2_Init(void)
{
    ...
    SYS_ResetModule(((4UL<<24) | (18)));    
    UART_Open(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL)), 115200);



    ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL)))->INTEN |= ((0x1ul << (15))));



    ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL)))->INTEN |= ((0x1ul << (15))));

}

void PDMA_WriteUART2SGTable(void)  
{
    DMA_UART2DESC[UART2_RX_BUFFER01].ctl =                       (((64) / 2 - 1) << (16)) |                         0x00000000UL |                            0x00000300UL |                            0x00000000UL |                            0x00000004UL |                         0x00000070UL |                            0x00000002UL;   
#line 388 "..\\main.c"
     
    DMA_UART2DESC[UART2_RX_BUFFER01].src = (uint32_t)((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL);
     
    DMA_UART2DESC[UART2_RX_BUFFER01].dest = (uint32_t)&UART2_P.g_u8RecData[0]; 
     
    DMA_UART2DESC[UART2_RX_BUFFER01].offset = (uint32_t)&DMA_UART2DESC[UART2_RX_BUFFER02] - (((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->SCATBA);  

    DMA_UART2DESC[UART2_RX_BUFFER02].ctl =                       (((64) / 2 - 1) << (16)) |                         0x00000000UL |                            0x00000300UL |                            0x00000000UL |                            0x00000004UL |                         0x00000070UL |                            0x00000002UL;   
#line 403 "..\\main.c"
     
    DMA_UART2DESC[UART2_RX_BUFFER02].src = (uint32_t)((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x32000UL);
     
    DMA_UART2DESC[UART2_RX_BUFFER02].dest = (uint32_t)&UART2_P.g_u8RecData[(64) / 2] ;  
     
    DMA_UART2DESC[UART2_RX_BUFFER02].offset = (uint32_t)&DMA_UART2DESC[UART2_RX_BUFFER01] - (((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->SCATBA);  

}

void PDMA_WriteUART1SGTable(void)  
{
    DMA_UART1DESC[UART1_RX_BUFFER01].ctl =                       (((64) / 2 - 1) << (16)) |                         0x00000000UL |                            0x00000300UL |                            0x00000000UL |                            0x00000004UL |                         0x00000070UL |                            0x00000002UL;   
#line 422 "..\\main.c"
     
    DMA_UART1DESC[UART1_RX_BUFFER01].src = (uint32_t)((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL);
     
    DMA_UART1DESC[UART1_RX_BUFFER01].dest = (uint32_t)&UART1_P.g_u8RecData[0]; 
     
    DMA_UART1DESC[UART1_RX_BUFFER01].offset = (uint32_t)&DMA_UART1DESC[UART1_RX_BUFFER02] - (((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->SCATBA);  

    DMA_UART1DESC[UART1_RX_BUFFER02].ctl =                       (((64) / 2 - 1) << (16)) |                         0x00000000UL |                            0x00000300UL |                            0x00000000UL |                            0x00000004UL |                         0x00000070UL |                            0x00000002UL;   
#line 437 "..\\main.c"
     
    DMA_UART1DESC[UART1_RX_BUFFER02].src = (uint32_t)((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL);
     
    DMA_UART1DESC[UART1_RX_BUFFER02].dest = (uint32_t)&UART1_P.g_u8RecData[(64) / 2] ;  
     
    DMA_UART1DESC[UART1_RX_BUFFER02].offset = (uint32_t)&DMA_UART1DESC[UART1_RX_BUFFER01] - (((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->SCATBA);  
}

void UART_PDMA_Init(void)
{
	( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_UART1_RX_end))) : ((BitFlag&=~(uint32_t)(1<<flag_UART1_RX_end))));
	( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_UART2_RX_end))) : ((BitFlag&=~(uint32_t)(1<<flag_UART2_RX_end))));
    ...
    PDMA_Open(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (1 << (1)));
    ...
    PDMA_SetTransferMode(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (0), 7UL, (1UL), (uint32_t)&DMA_UART1DESC[UART1_RX_BUFFER01]);



    PDMA_WriteUART2SGTable();
    PDMA_SetTransferMode(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (1), 9UL, (1UL), (uint32_t)&DMA_UART2DESC[UART2_RX_BUFFER01]);
...
#line 498 "..\\main.c"
    ...
    PDMA_EnableInt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (0), 0x00000002UL);

    PDMA_EnableInt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (1), 0x00000000UL);
    PDMA_EnableInt(((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL)), (1), 0x00000002UL);
...
void loop(void)
{
    ...
    {        
        ...
        if (UART1_P.g_u32comRhead != UART1_P.tmp)
        {
            ...
            UART1_P.g_u32comRhead = (UART1_P.g_u32comRhead == ((64) - 1)) ? 0 : (UART1_P.g_u32comRhead + 1);
            UART1_P.g_u32comRbytes--;
        }
    }
...
#line 579 "..\\main.c"
            ...
            UART2_P.g_u32comRhead = (UART2_P.g_u32comRhead == ((64) - 1)) ? 0 : (UART2_P.g_u32comRhead + 1);
            UART2_P.g_u32comRbytes--;
        }
    }


    if ((((BitFlag&(uint32_t)(1<<flag_UART1_RX_end))?1:0)))
    {
        ( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_UART1_RX_end))) : ((BitFlag&=~(uint32_t)(1<<flag_UART1_RX_end))));
    ...
    if ((((BitFlag&(uint32_t)(1<<flag_UART2_RX_end))?1:0)))
    {
        ( ((0UL) == 1) ? ((BitFlag|=(uint32_t)(1<<flag_UART2_RX_end))) : ((BitFlag&=~(uint32_t)(1<<flag_UART2_RX_end))));
...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(((1UL<<30)|(3UL<<28) |(0x3UL<<25) |(24UL<<20) |(3UL<<18) |(0xFUL<<10) |(0UL<<5) |(18UL<<0)), (0x3UL << (24)), (((1) - 1UL) << (0)));
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL &= ~((0xful << (8)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |= (0x08UL<<(8));



    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPL &= ~((0xful << (0)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPL |= (0x07UL<<(0));    
